<img src="<?= $arResult["img"] ?>" href="<?= $arResult["img"] ?>" class="img-thumbnail pull-right datailCardImg zoom">
...
<? if ($arResult["art"]): ?><strong>Артикул:</strong>    <?= $arResult["art"] ?><br/><? endif; ?>
...
<script>
    function initZoom() {
        ...
        $('img.zoom').elevateZoom({zoomWindowPosition: 11, zoomWindowOffetx:-10});
    }
    initZoom();
</script>