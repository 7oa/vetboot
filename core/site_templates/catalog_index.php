...
<div class="col-xs-9 rightContent">
        ...
        <div class="row">
            <div class="col-xs-4">
                <div class="search-select">
                    <span>Искать по</span>
                    <select class="form-control search-opt">
                        <option selected value="name">Наименованию</option>
                        <option value="code">Коду</option>
                        <option value="ean">ШтрихКоду</option>
                    </select>
                </div>
            </div>
            <div class="col-xs-8">
    ...
    <div>
        ...
        <div id="brandKey" style="display: none"></div>
        <div id="sortKey" style="display: none">name</div>
        <div id="startKey" style="display: none">100</div>
        <div id="amountKey" style="display: none">20</div>
